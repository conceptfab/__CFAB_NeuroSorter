...
class JpegToJpgConverter(QWidget):
    """Narzędzie do konwersji plików z rozszerzeniem .jpeg na .jpg"""
    ...
    def browse_folder(self):
        """Wybór folderu do przetworzenia."""
    ...
    def log_message(self, message, is_error=False):
        """Logowanie wiadomości w oknie logów."""
        if is_error:
    ...
    def start_conversion(self):
        ...
        try:
            ...
            self.log_message(
                f"Wystąpił nieoczekiwany błąd podczas przetwarzania: {e}",
                is_error=True,
            )
        finally:
